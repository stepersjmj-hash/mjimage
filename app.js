// ── 기본 데이터 ──────────────────────────────────────────
const DEFAULT_COMMON = "Produce Korean cosmetic production image with 1:1 ratio image, cut the result image 1:1 ratio, IMPORTANT: Absolute preservation of the original input product. A stunned close-up, dominant and centered view of the single cosmetic item, filling the frame prominently. Do NOT alter, redesign, or regenerate the product. Keep the exact shape, labels, colors, and details identical to the reference image.";

const DEFAULT_PROMPTS_TEXT = [
  { title: "욕실 배경", img: "img/1.png", text: "A high-resolution, square-aspect (1:1 ratio) professional product photograph in a clean and simple minimalist style. The single cosmetic product stands perfectly centered, prominently filling the frame. Only change the background and lighting environment. The product stands on a refined Carrara marble bathroom counter. The background is a gently blurred, pristine bathroom or vanity interior, with soft natural daylight illuminating from the side. The overall composition is premium and pristine." },
  { title: "손+대리석", img: "img/2.png", text: "A delicate female hand gently holding a luxury skincare serum bottle, resting on a clean white marble surface, pristine and minimal, soft morning sunlight, natural shadow, product showcase, clean aesthetic, empty space, 85mm lens, masterpiece, ultra-detailed" },
  { title: "유리 항아리", img: "img/3.png", text: "A premium cosmetic with a sleek minimalist design, placed on an exposed textured grey marble surface. Clean neutral background, soft studio lighting with gentle highlights, sophisticated, elegant, modern luxury skincare vibe, commercial macro photography, hyper-detailed, 8k, --ar 1:1 --style raw --v 6.0" },
  { title: "미니멀 스킨케어", img: "img/4.png", text: "A minimalist cosmetic skincare, resting on a clean white marble block with subtle grey veins. Soft natural sunlight filtering through a window, creating elegant and soft shadows. Bright and airy atmosphere, simple, luxurious, high-end commercial product photography, empty space for text, photorealistic, 8k, --ar 1:1 --style raw --v 6.0" },
  ...
  { title: "심플+자연광", img: "img/6.jpg", text: "A stunning, close-up minimalist beauty product photograph, focusing on a sleek serum bottle that is dominant and centered, filling the frame more prominently. The product stands centered on a smooth warm beige backdrop with soft natural studio lighting from the upper left, casting a gentle shadow to the right on a subtle gradient surface. A muted sandy-taupe background with soft vignette. Clean and calm mood, matte finish, no props, no text overlay. Seamless beige-to-cream gradient floor meeting a slightly darker beige wall. Shallow depth of field, high-end editorial K-beauty aesthetic, premium skincare brand visual. 1:1 portrait ratio, photorealistic, studio shot, neutral warm tones, soft ambient light." },
];
